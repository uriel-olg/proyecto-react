...
export const Home = () =>{
    ...
    <div className="bg-gradient-to-br from-[#0a0f2d] to-[#05122e] text-white">

        <Nav></Nav>

      {/* HERO */}
        <section className="grid md:grid-cols-2 gap-10 px-8 md:px-16 py-6 items-center">
            ...
            <ul className="space-y-3 text-gray-300">
                ...
                🔍 <span className="font-semibold">Ranking actualizado</span> del mercado cripto
                </li>
                <li className="flex gap-2">
                📊 <span className="font-semibold">Gráficos en vivo</span> de precios y tendencias
                </li>
                <li className="flex gap-2">
                📰 Noticias del mercado al instante
                </li>
                <li className="flex gap-2">
                🔐 <span className="font-semibold">Datos confiables</span> y en tiempo real
                </li>
            </ul>
